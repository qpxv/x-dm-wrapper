...
CREATE TABLE "XOAuthToken" (
    ...
    CONSTRAINT "XOAuthToken_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Contact_xUserId_key" ON "Contact"("xUserId");

-- CreateIndex
CREATE UNIQUE INDEX "Conversation_xConversationId_key" ON "Conversation"("xConversationId");

-- CreateIndex
CREATE UNIQUE INDEX "Message_xEventId_key" ON "Message"("xEventId");
...
-- CreateIndex
CREATE UNIQUE INDEX "ApiCallLog_date_key" ON "ApiCallLog"("date");
